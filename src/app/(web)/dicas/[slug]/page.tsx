...
export default async function Page({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start gap-20 md:p-10 p-4 bg-white text-neutral-800 mt-10">
      <div className="w-full sm:w-1/4 order-1 sm:order-0 min-h-72 border-2 rounded p-5 shadow-lg">
      ...
      <article className="w-full flex flex-col">
        <div>
          <h1 className="w-full text-center sm:text-start text-xl sm:text-3xl font-bold mb-4 pb-5 border-b">
            {tip.title}
          </h1>
          <div
