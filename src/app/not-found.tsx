...
export default function Page() {
  return (
    <div className="w-full h-screen flex items-center justify-center flex-col gap-5 bg-white">
      ...
      <p className="text-xl text-neutral-800">Oops, Não foi possível acessar a página</p>
      <Link href={"/"} className="bg-neutral-800 text-white text-neutral-800 py-2 px-5 rounded">Página Inicial</Link>
    </div>
  );
}
